...
admin_urlpatterns = [
    ...
    path("users/<int:pk>/suspend/",    views.AdminSuspendUserView.as_view(),   name="admin-suspend"),
    path("users/<int:pk>/unsuspend/",  views.AdminUnsuspendUserView.as_view(), name="admin-unsuspend"),
    path("users/<int:pk>/ban/",        views.AdminBanUserView.as_view(),       name="admin-ban"),
    path("otp-history/<int:user_id>/", views.AdminOTPHistoryView.as_view(),    name="admin-otp-history"),
