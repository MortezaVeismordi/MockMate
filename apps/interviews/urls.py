...
urlpatterns = [
    ...
    # =========================================================================
    path("", views.InterviewSessionListCreateView.as_view(), name="session-list-create"),
    ...
    path("<uuid:uuid>/", views.InterviewSessionDetailView.as_view(), name="session-detail-mutations"),
    path("<uuid:uuid>/report/", views.InterviewReportView.as_view(), name="session-report"),
    # =========================================================================
    ...
    path("admin/sessions/<uuid:uuid>/", views.AdminSessionDetailView.as_view(), name="admin-session-detail"),
    path("admin/answers/<int:pk>/", views.AdminAnswerDetailView.as_view(), name="admin-answer-detail"),
    path(
