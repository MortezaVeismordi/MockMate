...
from apps.interviews.models import InterviewSession, UserAnswer, SessionQuestion, InterviewMessage
...
class TestInterviewSessionModel:
    ...
    def test_interview_session_str_representation(self):
        ...
        expected_str = f"{user} | Senior Django Developer | {session.get_status_display()}"
...
class TestUserAnswerModel:
    ...
    def test_user_answer_str_representation(self):
        ...
        assert str(answer) == f"{user} | Q#{question.id} | {answer.get_status_display()}"
