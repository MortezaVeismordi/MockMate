...
from apps.interviews.models import InterviewSession, SessionQuestion, InterviewMessage, UserAnswer
from apps.questions.models import Question

from apps.users.tests.factories import (
    UserFactory, QuestionFactory,
    InterviewSessionFactory, SessionQuestionFactory, UserAnswerFactory,
)
...
class InterviewSessionModelTest(TestCase):
    ...
    def test_interview_session_status_choices(self):
        self.assertIn(self.session.status, [choice[0] for choice in InterviewSession.Status.choices])
    ...
    def test_interview_session_properties(self):
        ...
        self.session.completed_at = self.session.started_at + timezone.timedelta(minutes=30)
        self.session.save()
...
class SessionQuestionModelTest(TestCase):
    ...
    def test_session_question_creation(self):
        ...
        self.assertEqual(self.session_question.status, SessionQuestion.QuestionStatus.PENDING)
...
class InterviewMessageModelTest(TestCase):
    ...
    def test_interview_message_creation(self):
        ...
        self.assertEqual(self.message.message_type, InterviewMessage.MessageType.QUESTION)
...
class UserAnswerModelTest(TestCase):
    ...
    def test_user_answer_creation(self):
        ...
        self.assertEqual(self.user_answer.answer_text, 'Django is a high-level Python web framework that encourages rapid development.')
