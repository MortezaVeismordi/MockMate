...
class DevOpsExercisesAdapter(BaseQuestionAdapter):
    ...
    def extract(self) -> List[Dict[str, Any]]:
        ...
        EXCLUDED_FILES = {
            'readme.md', 'contributing.md', 'license.md', 'code_of_conduct.md',
            'contributing-pt-br.md', 'readme-fa.md', 'faq.md', 'faq-he.md'
        }
            ...
            for match in matches:
                ...
                if "<details>" in raw_body:
                    ...
                    if details_match:
                        ...
                        body_clean = re.sub(r'<details>.*?</details>', '', raw_body, flags=re.DOTALL | re.IGNORECASE).strip()
                else:
                ...
                if any(k in body_clean.lower() or k in title.lower() for k in ['advanced', 'architecture', 'production', 'optimize']):
