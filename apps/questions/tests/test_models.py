...
from apps.questions.models import Question, QuestionCategory, QuestionOption, QuestionAttachment
...
class TestQuestionModels(TestCase):
    ...
    def test_question_with_categories_and_options(self):
        ...
        opt1 = QuestionOption.objects.create(question=question, text="Option 1", is_correct=True)
        opt2 = QuestionOption.objects.create(question=question, text="Option 2", is_correct=False)
    ...
    def test_question_attachment(self):
        question = QuestionFactory.create(title="System Design", body="Design Whatsapp", reference_answer="Use WebSockets")
        ...
        self.assertEqual(attachment.attachment_type, QuestionAttachment.AttachmentType.IMAGE)
