            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=120,
                        help_text="زمان پیشنهادی برای پاسخ به این سوال",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="قالب کد اولیه برای سوالات کدنویسی",
                        null=True,
                ...
                (
                    "reference_answer",
                    models.TextField(
                        help_text="پاسخ ایده\u200cآل و نکات کلیدی برای راهنمایی تصحیح هوش مصنوعی",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="کلیدواژه\u200cهای اجباری و وزن نمره\u200cدهی",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("ai_generated", "AI Generated & Cached"),
                            ("github_import", "Imported from GitHub"),
                        ],
                        default="manual",
                        max_length=20,
                        verbose_name="Source",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("image", "Diagram / Image"),
                            ("code_file", "Configuration / Source Code File"),
                            ("document", "Supplementary Document"),
                        ],
                        default="code_file",
                        max_length=20,
